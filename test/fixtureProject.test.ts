...
const pathToArtifacts: string = path.join(__dirname, "fixture-projects/fixture-project/artifacts");
const pathToTestFolder: string = path.join(__dirname, "fixture-projects/fixture-project/test");

export function testFixtureProject() {
  useHardhatEnvironment("fixture-project");
